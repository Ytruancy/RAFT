...
python -u train.py --name raft-chairs --stage chairs --validation sintel --gpus 0 --num_steps 120000 --batch_size 8 --lr 0.00025 --image_size 368 496 --wdecay 0.0001 --mixed_precision 
#python -u train.py --name raft-things --stage things --validation sintel --restore_ckpt checkpoints/raft-chairs_0.4.pth --gpus 0 --num_steps 500000 --batch_size 5 --lr 0.0001 --image_size 400 720 --wdecay 0.0001 --mixed_precision
