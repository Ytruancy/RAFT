...
python -u train.py --name raft-chairs --stage chairs --validation chairs --gpus 0 --num_steps 50000 --batch_size 6 --lr 0.00025 --image_size 368 496 --wdecay 0.0001 --mixed_precision 
